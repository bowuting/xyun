 ...
 if(empty($_SESSION['uid'])){ ?>
    ...
    <div class="ui grid">
        <div class="sixteenth wide column">
          <h2>登录页面</h2>
            <form class="" action="/think/index.php/Login/Index/signinProcess" method="post">
...
$(document).ready(function(){
    ...
    $('#send_button').click(function(){
      ...
      $.post("/think/index.php/Login/Index/sendSms",{phonenum:phonenum},function(data,status){
