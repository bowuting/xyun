        ...
        <table class="table  table-bordered table-hover table-striped ">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        ...
                        <!-- <a class="btn btn-danger" href="/xyun/my_shop/index.php/Admin/Goods/deleteGoodsCat/id/<?php echo ($vo["goodscat_id"]); ?>"><i class="glyphicon glyphicon-remove"> 删除</i></a> -->
                    </td>
        ...
        $(document).ready(function(){
            $('.create_btn').click(function(){
                layer.open({                              // 添加  打开弹窗
                  ...
                  content: '/xyun/my_shop/index.php/Admin/Goods/createGoods',
                  closeBtn: 2,
                shift: 0,
                maxmin: true,
                moveType: 0,
            ...
            $('.update_btn').click(function(){
              var id = $(this).attr('data-id');
                layer.open({                              // 更新  打开弹窗
                  ...
                  area: ['800px', '600px'],
                  // shadeClose: true, //点击遮罩关闭
                  content: '/xyun/my_shop/index.php/Admin/Goods/updateGoods?id=' + id,
                  closeBtn: 2,
                shift: 0,
                maxmin: true,
                moveType: 0,
