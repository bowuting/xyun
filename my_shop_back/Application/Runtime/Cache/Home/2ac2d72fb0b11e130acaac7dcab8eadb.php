...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("[data-color]").click(function(){
            ...
            // alert(newvalue);
            if (newvalue == "all") {
                location.href="/xyun/my_shop/index.php/Home/Index/gallery.html".replace(reg,"");
            } else {
                if (oldvalue == "") {
                    location.href="/xyun/my_shop/index.php/Home/Index/gallery.html"+"/color/"+newvalue;

                } else {
                    location.href="/xyun/my_shop/index.php/Home/Index/gallery.html".replace(reg,"/color/"+newvalue);
                }
            }
        ...
        $("[data-price]").click(function(){
            ...
            if (newvalue == "all") {
                ...
                if (oldvalue == "") {
                    location.href="/xyun/my_shop/index.php/Home/Index/gallery.html"+"/price/"+newvalue;

                } else {
                    location.href="/xyun/my_shop/index.php/Home/Index/gallery.html".replace(reg,"/price/"+newvalue);
                }
            }
        });
        ...
        $("[data-price-2]").click(function(){
            ...
            // alert(newvalue);
                if (oldvalue == "") {
                    location.href="/xyun/my_shop/index.php/Home/Index/gallery.html"+"/price_2/"+newvalue;
                } else {
                    location.href="/xyun/my_shop/index.php/Home/Index/gallery.html".replace(reg,"/price_2/"+newvalue);
                }
        });
        ...
        $("[data-time]").click(function(){
            ...
            // alert(newvalue);
                if (oldvalue == "") {
                    location.href="/xyun/my_shop/index.php/Home/Index/gallery.html"+"/time/"+newvalue;
                } else {
                    location.href="/xyun/my_shop/index.php/Home/Index/gallery.html".replace(reg,"/time/"+newvalue);
                }
        });
        ...
        $('#searchbtn').click(function () {
          ...
          if (oldvalue == "") {
              location.href="/xyun/my_shop/index.php/Home/Index/gallery.html"+"/keyword/"+newvalue;
          } else {
              location.href="/xyun/my_shop/index.php/Home/Index/gallery.html".replace(reg,"/keyword/"+newvalue);
          }
        });
